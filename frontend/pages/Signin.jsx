...
const Signin = () => {
    ...
    return <div className={'bg-green-50 overflow-y-hidden'}>
      ...
      <div className={'flex flex-col h-screen justify-center '}>
        ...
        <div className={'border rounded-lg bg-white/5 xl:w-80 min-[400px]:w-60  min-[320px]:w-60 min-[280px]:w-40 text-center p-2 h-max px-4'}>
          ...
          <BottoWarning label={"Don't have an account?"} buttonText={"Sign up"} to={"/signup"} />
          <BottoWarning label={"Or go back to home"} buttonText={"Home"} to={"/"} />
        </div>
      </div>
    </div>
    </div>
